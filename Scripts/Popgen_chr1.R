...
ggsave(filename = "Plots/glct3_popgen.svg", height = 8, width = 12, dpi = 400)

# 
# 
# load("Propionate_IV_3684358-3894044_Diversity_Statistics.Rda")
# 
# glct6 <- c(3784358, 3794044)
# 
# td_df <- d2_df %>%
...
#   geom_point(size = point_size, alpha = point_alpha)+
#   scale_color_manual(values = c(highlight_color, "#222222"))+
#   geom_vline(aes(xintercept = glct6[1]/1e6), color = "#E68FAC")+
#   geom_vline(aes(xintercept = glct6[2]/1e6), color = "#E68FAC")+
#   # facet_grid(statistic~., scales = "free")+
#   # xlim(12,13)+
#   theme_bw(18) +
#   theme(legend.position = "none", axis.title.x = element_blank()) +
